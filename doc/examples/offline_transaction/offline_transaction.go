...
const (
	...
	genesisOutputSeed = "small rural airport hurdle host leader favorite viable total hold park cable blade wet other cat galaxy giggle bread knife silly tent electric leisure"
