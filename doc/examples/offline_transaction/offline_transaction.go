...
const (
	...
	genesisOutputSeed = "harvest soda uphold canvas alpha margin winter immune hundred century virus soap bind tired giggle wise logic cousin swear spirit inject monitor fatal middle"
