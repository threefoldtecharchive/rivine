...
func Wallettransactionscmd() {
	...
	for _, txn := range txns {
		...
		incomingSiacoinsFloat, _ := new(big.Rat).SetFrac(incomingSiacoins.Big(), currencyUnits.OneCoin.Big()).Float64()
		outgoingSiacoinsFloat, _ := new(big.Rat).SetFrac(outgoingSiacoins.Big(), currencyUnits.OneCoin.Big()).Float64()
